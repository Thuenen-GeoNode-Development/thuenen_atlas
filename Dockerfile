...
RUN mkdir -p /usr/src/thuenen_atlas
...
COPY src /usr/src/thuenen_atlas/
WORKDIR /usr/src/thuenen_atlas
...
RUN chmod +x /usr/src/thuenen_atlas/tasks.py \
    && chmod +x /usr/src/thuenen_atlas/entrypoint.sh
...
# ENTRYPOINT /usr/src/thuenen_atlas/entrypoint.sh
