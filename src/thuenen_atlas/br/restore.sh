...
echo "-----------------------------------------------------"
echo "STARTING thuenen_atlas RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./thuenen_atlas/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED thuenen_atlas RESTORE $(date)"
echo "-----------------------------------------------------"
