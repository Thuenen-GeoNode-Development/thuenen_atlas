...
try:
    from thuenen_atlas.local_settings import *
...
IMPORTER_HANDLERS = os.getenv('IMPORTER_HANDLERS', [
    ...
    'importer.handlers.datapackage.handler.DataPackageFileHandler',
...
# THUENEN_APPS = ( 'externalapplications', )
