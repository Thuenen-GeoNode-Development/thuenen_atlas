...
class Atlas(models.Model):
    """
    A collection of GeoNode resources (datasets, documents and maps) with
    additional information like a primer jumbotron and multi-media containers
    as HTML fields.
    """

    group = models.ManyToManyField(
        GroupProfile, related_name="group_collections", null=True, blank=True
    )
    ...
    jumbotronBackgroundImage = models.ImageField(
        upload_to="atlas/backgroundImage/%Y/%m",
        null=True,
        blank=True,
    ...
    thumbnail = models.ImageField(
        upload_to="atlas/thumbs/%Y/%m",
        null=True,
        blank=True,
        verbose_name="Atlas thumbnail",
    )

    jumbotronBackgroundMovie = models.FileField(
        upload_to="atlas/mov/%Y/%m",
        null=True,
        blank=True,
...
class CustomApplication(models.Model):
    """
    Application not created by Geonode which is part of an Atlas
    ...
    info = models.TextField(
        default="some additional information displayed for this custom app"
    )
    url = models.URLField(blank=False)
    thumbnail = models.ImageField(
        upload_to="atlas/customAppThumbs/%Y/%m",
        null=True,
        blank=True,
