...
class Roles(enum.Enum):
    ...
    POC = Role("pointOfContact", True, True, False)
    DISTRIBUTOR = Role("distributor", False, True, True)
    RESOURCE_USER = Role("user", False, True, True)
    RESOURCE_PROVIDER = Role("resourceProvider", False, True, True)
    ORIGINATOR = Role("originator", False, True, True)
    PRINCIPAL_INVESTIGATOR = Role("principalInvestigator", False, True, True)
